...
function back_to_normal(){
    document.getElementById("tab_grid").style.background = "url('p11.jpg')";
    setTimeout(reset_images,5000);
}
function redirect(){
    window.location="https://www.effoipizza.com/"
}
function switching(cell){
    if(number_mvs>80){
            ...
            document.getElementById("tab_grid").style.background = "url('pizzagif.gif')";
            document.getElementById('launch').onclick = function() { redirect() };
            document.getElementById("launch").textContent = "ORDER EFFOI PIZZA";
            document.getElementById('moves').textContent = "Opps You Lost!";
        ...
        switch(cell){
            ...
            case "p11":
                ...
                if(check_win()){
                        ...
                        document.getElementById("p33").style.visibility = "hidden";
                        document.getElementById("tab_grid").style.background = "url('pizzagif.gif')";
            document.getElementById("moves").textContent = "Congratulations You Win!";
            document.getElementById('launch').onclick = function() { redirect() };
            document.getElementById("launch").textContent = "ORDER EFFOI PIZZA NOW";
